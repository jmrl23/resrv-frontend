      ...
      <main className="flex flex-col lg:flex-row min-h-screen">
        <section className="w-full lg:max-w-screen-sm flex flex-col h-screen justify-center p-4">
          <div className="mt-auto">
            ...
            {
              error && (
                <div className="bg-red-100 border border-red-500 text-red-500 rounded pl-4 pr-2 py-2 my-4 max-w-sm mx-auto flex justify-between" ref={errorContainer}>
                  <div>
                    <h3 className="font-bold uppercase">Error</h3>
                    <p>{ error }</p>
                  </div>
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 lg:cursor-pointer" onClick={() => errorContainer.current?.remove()}>
            ...
            <a className="btn btn-black px-4 py-2 flex items-center justify-center gap-x-2 max-w-[250px] mx-auto" href="/api/auth/google" tabIndex={1} title='Sign In'>
              <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 48 48">
                <defs>
