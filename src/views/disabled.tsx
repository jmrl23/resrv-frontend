    ...
    <div className='p-4 h-screen flex items-center'>
      <div className='w-screen'>
        <div className='shadow rounded-lg prose p-4 text-slate-900 max-w-screen-sm mx-auto'>
          <h2 className='text-red-500'>Account Disabled</h2>
          <p>Paumanhin {user.givenName},</p>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur
            obcaecati, facilis consequuntur odio dolorum facere blanditiis
            perferendis, nostrum distinctio aliquid, vel inventore suscipit
            asperiores quibusdam. Rem voluptatum soluta nostrum accusantium!
          </p>
